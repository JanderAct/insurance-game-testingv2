...
// - Satisfaction is DERIVED, not ingested — the CSV carries no column for it.
//   The formula and the width's derivation are emitted into the catalog as
//   OPENING_SATISFACTION / openingSatisfaction; see that block. It was
//   6.2 + ((index*19)%23)/10 until the convex satisfaction rebuild narrowed it
//   to a range one funding decision could not hide.
